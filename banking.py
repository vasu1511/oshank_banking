...
def home_screen(pfrm=None):
    if(pfrm!=None):
        pfrm.destroy()
    frm=Frame(win)
    frm.configure(bg='light cyan')
    frm.place(x=0,y=140,relwidth=1,relheight=1)

    lbl_user=Label(frm,text="Username:",font=('',20,'bold'),bg='light cyan')
    ...
    lbl_pass=Label(frm,text="Password:",font=('',20,'bold'),bg='light cyan')
    entry_pass=Entry(frm,font=('',20,'bold'),bd=10,show="*")

    lbl_pass.place(relx=.3,rely=.2)
    entry_pass.place(relx=.42,rely=.2)

    lbl_type=Label(frm,text="User Type:",font=('',20,'bold'),bg='light cyan')
...
def welcome_screen(pfrm,entry_user,entry_pass,combo_type):
    ...
    if(tp=="---Select user---"):
        ...
        if(tup==None):
            ...
            left_frm=Frame(frm)
            left_frm.configure(bg='light cyan')
            left_frm.place(x=5,y=0,relwidth=.2,relheight=1)

            Label(left_frm,text=f"Welcome,{tup[0]}",font=('',15),bg='light cyan').place(x=2,y=2)
        ...
        if(user=="admin" and pwd=="admin"):
            ...
            Label(frm,text="Welcome,Admin",font=('',15),bg='light cyan').place(x=2,y=2)
    ...
    def viewcustomer_frame():
        f=Frame(frm)
        f.configure(bg='light cyan')
        f.place(x=250,y=20,relwidth=.7,relheight=.6)
        con=connect("bank.db")
        cur=con.cursor()
        cur.execute("select name,acn,type,bal,mob,email from useraccount")
        Label(f,text="Name",font=('',15,'bold'),bg='light cyan',fg='black').place(x=50,y=10)
        Label(f,text="ACN",font=('',15,'bold'),bg='light cyan',fg='black').place(x=150,y=10)
        Label(f,text="Type",font=('',15,'bold'),bg='light cyan',fg='black').place(x=250,y=10)
        Label(f,text="Avl. Bal",font=('',15,'bold'),bg='light cyan',fg='black').place(x=350,y=10)
        Label(f,text="Mob",font=('',15,'bold'),bg='light cyan',fg='black').place(x=450,y=10)
        Label(f,text="Email",font=('',15,'bold'),bg='light cyan',fg='black').place(x=550,y=10)
        
        i=50
        for row in cur:
            Label(f,text=f"{row[0]}",font=('',12),bg='light cyan',fg='black').place(x=50,y=i)
            Label(f,text=f"{row[1]}",font=('',12),bg='light cyan',fg='black').place(x=150,y=i)
            Label(f,text=f"{row[2]}",font=('',12),bg='light cyan',fg='black').place(x=250,y=i)
            Label(f,text=f"{row[3]}",font=('',12),bg='light cyan',fg='black').place(x=350,y=i)
            Label(f,text=f"{row[4]}",font=('',12),bg='light cyan',fg='black').place(x=450,y=i)
            Label(f,text=f"{row[5]}",font=('',12),bg='light cyan',fg='black').place(x=550,y=i)
    ...
    def checkbal_frame():
        ...
        bal=int(tupp[0])
        con.close()
        lbl_name=Label(f,text=f"Name:\t{tup[0]}",fg="green",font=('',20,'bold'),bg='light cyan')
        lbl_bal=Label(f,text=f"Balance:\t{bal}",fg="green",font=('',20,'bold'),bg='light cyan')
        lbl_type=Label(f,text=f"Type:\t{tup[2]}",fg="green",font=('',20,'bold'),bg='light cyan')
    ...
    def deposit_frame():
        ...
        f.configure(bg='light cyan')
        f.place(x=250,y=20,relwidth=.7,relheight=.6)
        lbl_amt=Label(f,text="Amount:",fg="green",font=('',20,'bold'),bg='light cyan')
    ...
    def transfer_frame():
        ...
        lbl_to=Label(f,text="To Acn:",fg="green",font=('',20,'bold'),bg='light cyan')
    ...
    def txnhistory_frame():
        ...
        Label(f,text="Date",font=('',15,'bold'),bg='light cyan',fg='black').place(x=100,y=10)
        Label(f,text="Amount",font=('',15,'bold'),bg='light cyan',fg='black').place(x=300,y=10)
        Label(f,text="Type",font=('',15,'bold'),bg='light cyan',fg='black').place(x=500,y=10)
        Label(f,text="Updated Bal",font=('',15,'bold'),bg='light cyan',fg='black').place(x=700,y=10)
        i=50
        for row in cur:
            Label(f,text=f"{row[1][:10]}",font=('',12),bg='light cyan',fg='black').place(x=100,y=i)
            Label(f,text=f"{row[2]}",font=('',12),bg='light cyan',fg='black').place(x=300,y=i)
            Label(f,text=f"{row[3]}",font=('',12),bg='light cyan',fg='black').place(x=500,y=i)
            Label(f,text=f"{row[4]}",font=('',12),bg='light cyan',fg='black').place(x=700,y=i)
            i=i+40
...
def fp_screen(pfrm):
    ...
    lbl_acn=Label(frm,text="Acno:",fg="green",font=('',20,'bold'),bg='light cyan')
    entry_acn=Entry(frm,font=('',20,'bold'),bd=10)

    lbl_mob=Label(frm,text="Mob:",fg="green",font=('',20,'bold'),bg='light cyan')
...
def open_screen(pfrm):
    ...
    lbl_email=Label(frm,text="Email:",fg="green",font=('',20,'bold'),bg='light cyan')
    entry_email=Entry(frm,font=('',20,'bold'),bd=10)

    lbl_name=Label(frm,text="Name:",fg="green",font=('',20,'bold'),bg='light cyan')
    entry_name=Entry(frm,font=('',20,'bold'),bd=10)

    lbl_pass=Label(frm,text="Password:",fg="green",font=('',20,'bold'),bg='light cyan')
    entry_pass=Entry(frm,font=('',20,'bold'),bd=10,show="*")

    lbl_type=Label(frm,text="Type:",fg="green",font=('',20,'bold'),bg='light cyan')
    combo_type = ttk.Combobox(frm, 
                            values=[
                                    "Saving", 
                                    "Current",
